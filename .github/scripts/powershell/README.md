**📍 Navigation Path:** [AGOG Home](../../../README.md) → [.github](../../) → [Scripts](../) → PowerShell**📍 Navigation Path:** [AGOG Home](../../README.md) → [.github](..) → Scripts



# PowerShell Scripts - Quick Reference# Git Workflow Scripts



**Platform:** Windows PowerShell> **Quick Start:** Choose your platform below and follow the instructions.
...
## Usage## Choose Your Platform



### Stage and Commit### 🪟 Windows (PowerShell)

```powershell

.\.github\scripts\powershell\stage.ps1**Location:** ``.github/scripts/powershell/``

```

**Scripts:**

### Commit Pre-Staged Files- ``stage.ps1`` - Interactive staging helper

```powershell- ``commit.ps1`` - Interactive commit builder

.\.github\scripts\powershell\commit.ps1- ``setup-commit-template.ps1`` - One-time template setup

```

**Usage:**

### One-Time Template Setup```powershell

```powershell# Stage and commit

.\.github\scripts\powershell\setup-commit-template.ps1.\.github\scripts\powershell\stage.ps1
...
See [Scripts README](../README.md) for complete documentation including:

- All menu options and workflows---

- Commit message format reference

- Examples and troubleshooting### 🐧 Linux / 🍎 macOS (Bash)
...
[⬆ Back to Scripts](../) | [🏠 AGOG Home](../../../README.md)- ``stage.sh`` - Interactive staging helper
