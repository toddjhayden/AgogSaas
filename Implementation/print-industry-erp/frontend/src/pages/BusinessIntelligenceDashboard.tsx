      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <KPICard
            ...
            unit="$"
            trend={getTrendDirection(kpiSummary?.financialKPIs.trend || 'stable')}
            trendPercent={5.2}
            sparklineData={[]}
          />
          <KPICard
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <KPICard
            ...
            unit="days"
            trend={getTrendDirection(kpiSummary?.operationalKPIs.trend || 'stable')}
            trendPercent={-2.3}
            sparklineData={[]}
          />
          <KPICard
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <KPICard
              ...
              unit="days"
              trend={getTrendDirection(kpiSummary?.vendorKPIs.trend || 'stable')}
              trendPercent={-1.5}
              sparklineData={[]}
            />
            <KPICard
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <KPICard
              ...
              unit=""
              trend={getTrendDirection(kpiSummary?.customerKPIs.trend || 'stable')}
              trendPercent={5.3}
              sparklineData={[]}
            />
            <KPICard
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <KPICard
            ...
            unit="%"
            trend={getTrendDirection(kpiSummary?.forecastKPIs.trend || 'stable')}
            trendPercent={2.5}
            sparklineData={[]}
          />
          <KPICard
