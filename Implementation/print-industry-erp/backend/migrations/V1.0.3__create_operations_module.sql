-- =====================================================
-- FLYWAY MIGRATION V1.0.3
-- =====================================================
-- Purpose: Create operations module - production planning, scheduling, OEE
-- Tables: 11 (work_centers, production_orders, operations, production_runs, 
--         changeover_details, equipment_status_log, maintenance_records,
--         asset_hierarchy, oee_calculations, production_schedules, capacity_planning)
