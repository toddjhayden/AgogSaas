-- =====================================================
-- FLYWAY MIGRATION V1.0.5
-- =====================================================
-- Purpose: Create finance module - GL, AR, AP, multi-currency, multi-entity
-- Tables: 10 (financial_periods, chart_of_accounts, exchange_rates, journal_entries,
--         journal_entry_lines, gl_balances, invoices, invoice_lines, payments, cost_allocations)
-- Dependencies: V1.0.2 (core multitenant)
-- Created: 2025-12-16
-- =====================================================
