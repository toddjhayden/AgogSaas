-- =====================================================
-- FLYWAY MIGRATION V1.0.7
-- =====================================================
-- Purpose: Create quality, HR, IoT, security, marketplace, and imposition modules
-- Tables: 30 (quality_standards, inspection_templates, quality_inspections, quality_defects,
--         customer_rejections, employees, labor_rates, timecards, labor_tracking,
--         iot_devices, sensor_readings, equipment_events, security_zones, security_access_log,
--         chain_of_custody, partner_network_profiles, marketplace_job_postings, marketplace_bids,
--         external_company_orders, press_specifications, substrate_specifications,
--         imposition_templates, layout_calculations, imposition_marks, plus 5 more)
