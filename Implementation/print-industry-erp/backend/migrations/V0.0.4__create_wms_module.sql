-- =====================================================
-- FLYWAY MIGRATION V1.0.4
-- =====================================================
-- Purpose: Create WMS module - warehouse management, inventory, wave processing
-- Tables: 13 (inventory_locations, lots, inventory_transactions, wave_processing,
...
-- Dependencies: V1.0.2 (core multitenant), V1.0.3 (operations)
-- Created: 2025-12-16
-- =====================================================
