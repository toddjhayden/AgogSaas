...
-- =====================================================
-- Purpose: Create core multi-tenant foundation tables
-- Tables: 5 (currencies, tenants, billing_entities, facilities, users)
-- Dependencies: V1.0.0 (extensions), V1.0.1 (monitoring)
-- Created: 2025-12-16
-- =====================================================
...
-- Note: Created FIRST because tenants reference it via default_currency_code
