...
// Vendor Performance Services (REQ-STRATEGIC-AUTO-1766627342634)
import { vendorPerformanceResolvers } from './graphql/resolvers/vendor-performance.resolver';

// Inventory Forecasting Services (REQ-STRATEGIC-AUTO-1766675619639)
...
const vendorPerformanceTypeDefs = readFileSync(
  join(__dirname, 'graphql/schema/vendor-performance.graphql'),
  'utf-8'
);
...
async function startServer() {
  try {
    ...
    console.log('  - Vendor Scorecards: Enabled (REQ-STRATEGIC-AUTO-1766627342634)');
