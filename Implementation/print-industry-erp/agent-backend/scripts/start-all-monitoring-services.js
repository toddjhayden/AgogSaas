...
const health_monitor_service_1 = require("../src/monitoring/health-monitor.service");
const berry_auto_deploy_service_1 = require("../src/agents/berry-auto-deploy.service");
const deployment_executor_service_1 = require("../src/agents/deployment-executor.service");
...
async function startAllServices() {
    ...
    try {
        ...
        const berryAutoDeploy = new berry_auto_deploy_service_1.BerryAutoDeployService();
        ...
        const deploymentExecutor = new deployment_executor_service_1.DeploymentExecutor();
