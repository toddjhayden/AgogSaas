...
async function main() {
    ...
    try {
        ...
        const recovery = new recovery_health_check_daemon_1.RecoveryHealthCheckDaemon();
        ...
        const valueChain = new value_chain_expert_daemon_1.ValueChainExpertDaemon();
        await valueChain.initialize();
        // Access private method via reflection for testing
        await valueChain.runEvaluation();
        console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
