...
- `sdlc-gui/src/types/ai-functions.ts` - Function definitions ✅
- `sdlc-gui/src/services/ai-function-executor.ts` - Function executor ✅
- `sdlc-gui/src/services/ai-function-handler.ts` - Handler ✅
- `agent-backend/migrations/sdlc-control/V0.0.30__create_workflow_directives.sql` - Migration ✅
- `sdlc-api.server.ts` line 1841: `/requests/:reqNumber/blocked-by` ✅
- `sdlc-api.server.ts` line 1898: `/requests/:reqNumber/blocker-chain` ✅
- `sdlc-api.server.ts` line 1961: `/requests/unblocked` ✅
- `sdlc-api.server.ts` line 2300: `/requests/:reqNumber/estimate` ✅
- `sdlc-api.server.ts` line 2469: `/workload/analyze` ✅
