...
- Missing imports
- Type mismatches (props, state, GraphQL types)
...
|---------|-----------------|---------------|
| **YOU (Jen the agent)** | YES | You CAN publish deliverables to NATS |
| **YOUR CODE (application frontend)** | NO | Frontend code MUST NOT use NATS/WebSockets to agents |
...
2. Note the dependency in your deliverable:
   ...
   - [ ] Backend API changes needed (Roy)
